...
@section('content')
<section class="hero-wrap hero-wrap-2" style="background-image: url('/images/bg_application.jpg');">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                ...
                <h1 class="mb-0 bread">Graphic Desigh</h1>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-7 heading-section text-center ftco-animate">
                <span class="subheading">Graphic Desigh</span>
                <h2>Price &amp; Plans</h2>
            </div>
        </div>
        <div class="row">
